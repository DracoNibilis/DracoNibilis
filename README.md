...
pinned_projects:
  [
    ...
    Google_Data_Analytics_Capstone-Case_Study: ["RStudio based analysis of BellaBeat smart device data. Main task was focused on
                                                 gaining insight into how customers are using their smart devices, based on registered activity.
